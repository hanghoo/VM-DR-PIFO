...
control MyIngress(inout headers hdr,
    ...
    apply {
		...
		level_0_rank = (bit<48>)hdr.ipv4.options + (bit<48>)(standard_metadata.ingress_global_timestamp);
...
control MyEgress(inout headers hdr,
    ...
    apply { 
		...
		hdr.ipv4.options = hdr.ipv4.options - (bit<32>)(standard_metadata.egress_global_timestamp) + (bit<32>)(standard_metadata.ingress_global_timestamp);
