...
// this is a 3-level hierarchy, because there are FIFOs by default in the lowest level (1 FIFO queue for each flow).
// if you want to add an extra level of FIFOs, increase the number_of_levels_used to 3, and add level_2_rank
// then make level_0_rank = in_pkt_ptr or ingress_global_timestamp, level_1_rank for WFQ, and level_2_rank for SP		
