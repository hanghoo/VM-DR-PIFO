...
control MyIngress(inout headers hdr,
    ...
    bit <48> level_0_rank;
    bit <48> in_pred= 200000; // time step is 1ms , so 1000 = 1 seconds
    bit <48> in_pkt_ptr;
	...
	floor_extern_obj.floor((in_flow_id-1), (bit<48>)(15), flow_id_at_level_1); // 72 flows / 5 queues	
	...
	my_hier.pass_rank_values(level_0_rank,0);
            ...
            my_hier.my_scheduler(flow_id_at_level_1, number_of_levels_used, in_pred, in_pkt_ptr, in_shaping, in_enq, in_pkt_ptr, in_deq, reset_time);
        }
